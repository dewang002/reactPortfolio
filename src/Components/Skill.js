...
function Skill() {
  ...
  return (
    <div id="skill" className=" md:h-[64vh] w-full flex flex-col items-center cursor-default pt-10"
    >
      <Link
        className="-translate-x-[28vw] absolute bg-blue-500 py-2 px-4 rounded text-white active:scale-75 duration-100 transition-all"
        onClick={() => navigate(-1)}
      >
